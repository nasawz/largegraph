      ...
      <div id="canvas-menu">
        <div className="icon-container">
          ...
          <span
            ...
            onMouseEnter={(e) =>
              showItemTip(e, fisheyeEnabled ? '关闭鱼眼放大镜' : '打开鱼眼放大镜')
            }
            onMouseLeave={hideItemTip}
          >
            {fisheyeEnabled ? (
          ...
          <span
            ...
            onMouseEnter={(e) =>
              showItemTip(e, lassoEnabled ? '关闭拉索选择模式' : '打开拉索选择模式')
            }
            onMouseLeave={hideItemTip}
          >
          ...
          <span
            ...
            onMouseEnter={(e) => showItemTip(e, '搜索最短路径')}
            onMouseLeave={hideItemTip}
          >
          ...
          <span className="icon-span" style={{ width: 'fit-content', ...iconStyle.disable }}>
            <span
              ...
              onMouseEnter={(e) => showItemTip(e, '缩小')}
              onMouseLeave={hideItemTip}
            >
              -
            </span>
            <span
              ...
              onMouseEnter={(e) => showItemTip(e, '图内容适配容器，快捷键：ctrl + 1')}
              onMouseLeave={hideItemTip}
            ...
            <span
              ...
              onMouseEnter={(e) => showItemTip(e, '放大')}
              onMouseLeave={hideItemTip}
            >
              +
            </span>
          ...
          <span
            ...
            onMouseEnter={(e) => showItemTip(e, '输入 ID 搜索节点')}
            onMouseLeave={hideItemTip}
          >
          ...
          {enableSearch && (
            <span
              onMouseEnter={(e) => showItemTip(e, '输入需要搜索的节点 ID，并点击 Submit 按钮')}
              onMouseLeave={hideItemTip}
            >
          ...
          {enableSelectPathEnd && (
            <span
              onMouseEnter={(e) =>
                showItemTip(e, '选择有且仅有两个节点作为端点，并点击 Find Path 按钮')
              }
              onMouseLeave={hideItemTip}
            >
