...
let louvain: any = null;
let findShortestPath: any = null;
...
const processNodesEdges = (
    ...
    edges.forEach((edge) => {
        ...
        let arrowPath: any = `M ${arrowBeging},0 L ${arrowBeging + arrowLength},-${arrowWidth} L ${arrowBeging + arrowLength
            },${arrowWidth} Z`;
...
const getNeighborMixedGraph = (
    ...
    const neighborSubGraph: any = generateNeighbors(centerNodeModel, step, maxNeighborNumPerNode);
